...
with st.sidebar:
    st.title('Tri variate Gaussian Distribution')
...
fig.update_layout(scene=dict(xaxis_title=r'x_1', yaxis_title=r'x_2', zaxis_title=r'x_3'), width=1000, margin=dict(r=20, b=10, l=10, t=10))
